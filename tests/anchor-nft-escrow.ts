...
describe("anchor-nft-escrow", () => {
  ...
  xit("Creates a PNftA", async () => {
    ...
    console.log("makerTokenRecordA", makerTokenRecordA.toString())
    console.log("takerTokenRecordA", takerTokenRecordA.toString())
  });

  xit("Creates a PNftB", async () => {
    // Metaplex Setup
    const umi = createUmi(connection.rpcEndpoint);
    let umiKeypair = umi.eddsa.createKeypairFromSecretKey(taker.secretKey);
    const signerKeypair = createSignerFromKeypair(umi, umiKeypair);
    ...
    console.log("makerTokenRecordB", makerTokenRecordB.toString())
